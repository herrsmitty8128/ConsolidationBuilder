...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Elim_Plug_CC_3 = QtWidgets.QLineEdit(self.groupBox_9)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.Elim_Plug_CC_3.setFont(font)
        self.Elim_Plug_CC_3.setObjectName("Elim_Plug_CC_3")
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.Elim_Plug_CC_3)
        ...
        self.Elim_Plug_Acct_3 = QtWidgets.QLineEdit(self.groupBox_9)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.Elim_Plug_Acct_3.setFont(font)
        self.Elim_Plug_Acct_3.setObjectName("Elim_Plug_Acct_3")
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.Elim_Plug_Acct_3)
        ...
        self.Elim_Plug_CC_2 = QtWidgets.QLineEdit(self.groupBox_8)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.Elim_Plug_CC_2.setFont(font)
        self.Elim_Plug_CC_2.setObjectName("Elim_Plug_CC_2")
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.Elim_Plug_CC_2)
        ...
        self.Elim_Plug_Acct_2 = QtWidgets.QLineEdit(self.groupBox_8)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.Elim_Plug_Acct_2.setFont(font)
        self.Elim_Plug_Acct_2.setObjectName("Elim_Plug_Acct_2")
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.Elim_Plug_Acct_2)
        ...
        self.Elim_Desc_2 = QtWidgets.QTextEdit(self.groupBox_10)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.Elim_Desc_2.setFont(font)
        self.Elim_Desc_2.setObjectName("Elim_Desc_2")
        self.verticalLayout_19.addWidget(self.Elim_Desc_2)
        self.horizontalLayout_22 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_22.setObjectName("horizontalLayout_22")
        self.clearElimDescriptionButton_2 = QtWidgets.QPushButton(self.groupBox_10)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.clearElimDescriptionButton_2.setFont(font)
        icon = QtGui.QIcon.fromTheme("edit-clear")
        self.clearElimDescriptionButton_2.setIcon(icon)
        self.clearElimDescriptionButton_2.setObjectName("clearElimDescriptionButton_2")
        self.horizontalLayout_22.addWidget(self.clearElimDescriptionButton_2)
        self.copyElimDescriptionButton_2 = QtWidgets.QPushButton(self.groupBox_10)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.copyElimDescriptionButton_2.setFont(font)
        icon = QtGui.QIcon.fromTheme("edit-copy")
        self.copyElimDescriptionButton_2.setIcon(icon)
        self.copyElimDescriptionButton_2.setObjectName("copyElimDescriptionButton_2")
        self.horizontalLayout_22.addWidget(self.copyElimDescriptionButton_2)
        self.pasteElimDescriptionButton_2 = QtWidgets.QPushButton(self.groupBox_10)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.pasteElimDescriptionButton_2.setFont(font)
        icon = QtGui.QIcon.fromTheme("edit-paste")
        self.pasteElimDescriptionButton_2.setIcon(icon)
        self.pasteElimDescriptionButton_2.setObjectName("pasteElimDescriptionButton_2")
        self.horizontalLayout_22.addWidget(self.pasteElimDescriptionButton_2)
        ...
        self.Documentation_2 = QtWidgets.QTableView(self.groupBox_5)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.Documentation_2.setFont(font)
        self.Documentation_2.setAlternatingRowColors(True)
        self.Documentation_2.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.Documentation_2.setSortingEnabled(True)
        self.Documentation_2.setObjectName("Documentation_2")
        self.verticalLayout_15.addWidget(self.Documentation_2)
        self.horizontalLayout_17 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_17.setObjectName("horizontalLayout_17")
        self.addElimDocButton_2 = QtWidgets.QPushButton(self.groupBox_5)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.addElimDocButton_2.setFont(font)
        icon = QtGui.QIcon.fromTheme("list-add")
        self.addElimDocButton_2.setIcon(icon)
        self.addElimDocButton_2.setObjectName("addElimDocButton_2")
        self.horizontalLayout_17.addWidget(self.addElimDocButton_2)
        self.deleteElimDocButton_2 = QtWidgets.QPushButton(self.groupBox_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.deleteElimDocButton_2.sizePolicy().hasHeightForWidth())
        self.deleteElimDocButton_2.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.deleteElimDocButton_2.setFont(font)
        icon = QtGui.QIcon.fromTheme("list-remove")
        self.deleteElimDocButton_2.setIcon(icon)
        self.deleteElimDocButton_2.setAutoDefault(False)
        self.deleteElimDocButton_2.setDefault(False)
        self.deleteElimDocButton_2.setFlat(False)
        self.deleteElimDocButton_2.setObjectName("deleteElimDocButton_2")
        self.horizontalLayout_17.addWidget(self.deleteElimDocButton_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_7.setTitle(_translate("MainWindow", "Entities and Ownership Percentages"))
        self.pushButton_2.setText(_translate("MainWindow", "Add Entity"))
        self.pushButton.setText(_translate("MainWindow", "Delete Entity(ies)"))
        self.groupBox_9.setTitle(_translate("MainWindow", "Balance Sheet"))
        self.label_23.setText(_translate("MainWindow", "Cost Center"))
        self.Elim_Plug_CC_3.setToolTip(_translate("MainWindow", "Plug any remaining difference to this cost center number"))
        self.label_24.setText(_translate("MainWindow", "Account"))
        self.Elim_Plug_Acct_3.setToolTip(_translate("MainWindow", "Plug any remaining difference to this account number"))
        self.groupBox_8.setTitle(_translate("MainWindow", "Income Statement"))
        self.label_21.setText(_translate("MainWindow", "Cost Center"))
        self.Elim_Plug_CC_2.setToolTip(_translate("MainWindow", "Plug any remaining difference to this cost center number"))
        self.label_22.setText(_translate("MainWindow", "Account"))
        self.Elim_Plug_Acct_2.setToolTip(_translate("MainWindow", "Plug any remaining difference to this account number"))
        self.groupBox_10.setTitle(_translate("MainWindow", "Notes"))
        self.Elim_Desc_2.setToolTip(_translate("MainWindow", "Enter a full description of the eliminating entry here..."))
        self.clearElimDescriptionButton_2.setToolTip(_translate("MainWindow", "Erase the elimination description box"))
        self.clearElimDescriptionButton_2.setText(_translate("MainWindow", "Clear Notes"))
        self.copyElimDescriptionButton_2.setToolTip(_translate("MainWindow", "Copy elimination description to the clipboard"))
        self.copyElimDescriptionButton_2.setText(_translate("MainWindow", "Copy Notes"))
        self.pasteElimDescriptionButton_2.setToolTip(_translate("MainWindow", "Paste text from the clipboard into the description at the current cursor position"))
        self.pasteElimDescriptionButton_2.setText(_translate("MainWindow", "Paste Notes"))
        self.groupBox_5.setTitle(_translate("MainWindow", "Documentation"))
        self.Documentation_2.setToolTip(_translate("MainWindow", "Insert the file path of supporting documents here..."))
        self.addElimDocButton_2.setToolTip(_translate("MainWindow", "Add a new supporting document to the table"))
        self.addElimDocButton_2.setText(_translate("MainWindow", "Add Document"))
        self.deleteElimDocButton_2.setToolTip(_translate("MainWindow", "Delete the selected supporting documents from the table"))
        self.deleteElimDocButton_2.setText(_translate("MainWindow", "Document(s)"))
